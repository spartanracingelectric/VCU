...
//512: Power Limit PID Output Details
 ...
 //513: Power Limit LUT Parameters
   canMessageCount++;
    ...
    canMessages[canMessageCount - 1].id_format = IO_CAN_STD_FRAME;
    canMessages[canMessageCount - 1].id = canMessageID + canMessageCount - 1;
    canMessages[canMessageCount - 1].data[byteNum++] = pl->pid->Kp;
    canMessages[canMessageCount - 1].data[byteNum++] = pl->pid->Kp >> 8;
    canMessages[canMessageCount - 1].data[byteNum++] = pl->pid->Ki;
