...
#define DERATE_ENABLED 0
#define BMS_TEMPERATURE_SCALE 10

// derating disabled for now
#define POWER_LIM_ENABLED 0
#if DERATE_ENABLED
#define POWER_LIM_UPPER_POWER_THRESH 80 * 1000
#define POWER_LIM_LOWER_POWER_THRESH 70 * 1000
#else
#define POWER_LIM_UPPER_POWER_THRESH 60 * 1000
#define POWER_LIM_LOWER_POWER_THRESH 55 * 1000
#endif


#define POWER_LIM_TAKEAWAY_SCALAR(maxTorque, lowerTorqueLim) \
 ((sbyte2) ((((maxTorque) - (lowerTorqueLim)) / 10) / \
((POWER_LIM_UPPER_POWER_THRESH - POWER_LIM_LOWER_POWER_THRESH) / 1000)))
