...
/** THE PURPOSE OF THIS FILE IS TO GLOBALLY DEFINE WIDELY USED VALUES. IF YOU WISH TO DEFINE SOMETHING WITH A NARROW AND SPECIFIC FOCUS, OR A NARROW AND SPECIFIC USE CASE, USE A MORE APPROPIATE FILE THAN THIS ONE. **/
#include "ptypes_xe167.h"
    ...
    #define MOTOR_AND_CONTROLS_SYSTEMS
            ...
            #define MCM_MAX_TORQUE (ubyte2) 2310
        #endif
