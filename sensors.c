...
void sensors_updateSensors(void)
{
    ...
    */
    ...
    //Wheel speed sensors ---------------------------------------------------
    Sensor_WSS_FL.ioErr_signalGet = IO_PWD_FreqGet(IO_PWD_06, &Sensor_WSS_FL.sensorValue);
    Sensor_WSS_FR.ioErr_signalGet = IO_PWD_FreqGet(IO_PWD_04, &Sensor_WSS_FR.sensorValue);
    Sensor_WSS_RL.ioErr_signalGet = IO_PWD_FreqGet(IO_PWD_05, &Sensor_WSS_RL.sensorValue);
    Sensor_WSS_RR.ioErr_signalGet = IO_PWD_FreqGet(IO_PWD_07, &Sensor_WSS_RR.sensorValue);
